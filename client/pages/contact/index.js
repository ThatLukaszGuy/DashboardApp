...
export default function contact() {
  ...
  return (
    ...
    <div className='bg-gray-700  flex flex-col md:flex-row'>
      <div className='contact-container  w-screen  md:w-[50vw]'>
        <SubNav currentRoute='contact' icon={<FaPhone size={32}/>}/>
        <h1 className=' text-white mt-[20vh] pixel font-thin text-[60px] z-50 relative'  >Contact</h1>
        <p className='text-gray-400 text-2xl z-50 just-pixel  relative mx-2'>If you wish to work with me, please fill out the form below</p>
        <div className="custom-shape-divider-bottom-1653421206 z-0 md:hidden">
      ...
      <div className=' mt-[8vh] md:mt-[20vh]'>
        <div className=' md:w-[45vw] mx-[2.5vw] flex sm:flex-row flex-col rounded-md border-gray-600 bg-gray-900 border p-3 justify-between'>
          <div className='flex '>
              <Avatar src='/images/nopfp.jpeg' />        
              <Box ml='3' >
                ...
                <div className=''>
                  ...
                  <Text fontSize='sm' color='gray.200'>Wanna learn more about how your data is handled? </Text>
                </div>
        ...
        <div className='min-h-[50vh] md:w-[45vw] mx-[2.5vw] bg-gray-700 '>
          <form ref={form} className='  bg-gray-900 border border-gray-600 rounded-md p-5 mt-5 shadow-lg' onSubmit={sendEmail}>

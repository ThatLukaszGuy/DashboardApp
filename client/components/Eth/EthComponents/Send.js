...
export default function Send() {
  ...
  const parse = (val) => val.toString().replace(/^\$/, '').replace( /e/i,'')
    ...
    <div>
      ...
      <form onSubmit={async e => {
            ...
            <FormControl mt='4'>
                ...
                <NumberInput min={0.00000001}  defaultValue={0.1} step={0.1} onChange={(amount) => handleChange(parse(amount))} focusBorderColor='tailwindPink.500'>

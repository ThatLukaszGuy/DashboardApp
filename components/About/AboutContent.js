          ...
          <div className="flex flex-col items-center bg-gray-700 rounded-lg shadow-md  md:flex-row">
            ...
            <div className="flex flex-col justify-between p-4 leading-normal" >
                ...
                <p className="mb-3 font-normal text-white text-left">
                  This site is a web3 dashboard app running on the moralis framework and built in a next js application. Find out more in the github docs <a href='https://github.com/ThatLukaszGuy/SolEthDashboard/blob/main/README.md' className='underline' target='_blank'>here</a>

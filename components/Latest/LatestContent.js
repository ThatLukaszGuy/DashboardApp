  ...
  return (
    <div className='grid sm:grid-cols-2 gap-4  grid-cols-1 mt-10 sm:mt-20 z-0'>
        ...
        <div className="p-6 max-w-sm  rounded-lg border z-0 shadow-md bg-zinc-800 border-zinc-700 sm:hover:scale-105 hover:z-50 ease-in-out duration-300 hover:transform-none">
            ...
            <Link href={'/news'}>
                <a className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-pink-700 rounded-lg hover:bg-pink-800 focus:ring-4 focus:outline-none focus:ring-pink-300 dark:bg-pink-600 dark:hover:bg-pink-700 dark:focus:ring-pink-800">
                    See more
